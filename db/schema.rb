...
ActiveRecord::Schema.define(version: 20140901070929) do
  ...
  add_index "opinions", ["book_id"], name: "index_opinions_on_book_id", using: :btree
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "confirmed_at"
    t.datetime "confirmation_sent_at"
    t.string   "authauthenticity__token"
    t.boolean  "is_active"
  end
